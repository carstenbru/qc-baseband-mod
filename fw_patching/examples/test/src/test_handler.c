/**
 * @file test_handler.c
 * @brief simple framework "pointer_table" and "overwrite" attribute test, overwriting QMI test service ping-handler and introducing a new handler
 *
...
// __attribute__ ((overwrite ("qmi_ping_svc_ping_data_response")))
// unsigned int seemoo_ping_response (
//   void*             clnt_info,
//   void*             req_handle,
//   unsigned int      msg_id,
//   void*             req_c_struct,
